package nudelauflauch.curd_mod.common.containers;
...
/*
public class JamMakerConatainer extends Container {
	private TileEntity tileEntity;
	private PlayerEntity playerEntity;
	private IItemHandler playerInventory;

	public JamMakerConatainer(int windowId, World world, BlockPos pos, PlayerInventory playerInventory,
			PlayerEntity player) {
		super(TileEntityTypesInit.JAM_MAKER_ENTITY_TYPE.get(), windowId);
